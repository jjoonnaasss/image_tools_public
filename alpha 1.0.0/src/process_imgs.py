...
class Params:
    def __init__(self, width=None, height=None, pos=None, left=None, top=None, perc=None, contrast=None, saturation=None,
                 brightness=None, sharpness=None, flip_mode=None, angle=None):
...
# resizes the given image to specific dimensions, params include the dimensions (width, height)
